...
/* NOTE: UART handles are defined in bsp_uart.c, not here */


/* SPIX_F pins 128 Mbit NOR -------------------------------------------------------------------------------------------------------*/

const mxc_gpio_cfg_t bsp_pins_spixf_active_cfg = {
    .port = MXC_GPIO0,
    .mask = (MXC_GPIO_PIN_7 | MXC_GPIO_PIN_8 | MXC_GPIO_PIN_9 | MXC_GPIO_PIN_10 | MXC_GPIO_PIN_11 | MXC_GPIO_PIN_12),
...
const mxc_gpio_cfg_t bsp_pins_spi3_active_cfg = {
        .port = MXC_GPIO0,
        .mask = (MXC_GPIO_PIN_15 | MXC_GPIO_PIN_16 | MXC_GPIO_PIN_17 | MXC_GPIO_PIN_19 | MXC_GPIO_PIN_20 | MXC_GPIO_PIN_21),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIOH,
        .drvstr = MXC_GPIO_DRVSTR_0,
 ...
 const mxc_gpio_cfg_t bsp_pins_spi3_high_z_cfg = {
        .port = MXC_GPIO0,
        .mask = (MXC_GPIO_PIN_15 | MXC_GPIO_PIN_16 | MXC_GPIO_PIN_17 | MXC_GPIO_PIN_19 | MXC_GPIO_PIN_20 | MXC_GPIO_PIN_21),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_IN,
...
const mxc_gpio_cfg_t bsp_pins_1v8_i2c_active_cfg = {
        .port = MXC_GPIO2,
        .mask = (MXC_GPIO_PIN_7 | MXC_GPIO_PIN_8),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
...
const mxc_gpio_cfg_t bsp_pins_1v8_i2c_high_z_cfg = {
        .port = MXC_GPIO2,
        .mask = (MXC_GPIO_PIN_7 | MXC_GPIO_PIN_8),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_OUT,
...
const mxc_gpio_cfg_t bsp_pins_sdhc_active_cfg = {
        .port = MXC_GPIO1,
        .mask = (MXC_GPIO_PIN_0 | MXC_GPIO_PIN_1 | MXC_GPIO_PIN_3 | MXC_GPIO_PIN_4 | MXC_GPIO_PIN_5 | MXC_GPIO_PIN_6),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIOH,
        .drvstr = MXC_GPIO_DRVSTR_0,
...
const mxc_gpio_cfg_t bsp_pins_adc_cfg_spi_active_cfg = {
        .port = MXC_GPIO2,
        .mask = (MXC_GPIO_PIN_2 | MXC_GPIO_PIN_3 | MXC_GPIO_PIN_4),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIO,
        .drvstr = MXC_GPIO_DRVSTR_0,
...
const mxc_gpio_cfg_t bsp_pins_adc_ch0_data_spi_active_cfg = {
        .port = MXC_GPIO1,
        .mask = (MXC_GPIO_PIN_23 | MXC_GPIO_PIN_26 | MXC_GPIO_PIN_29),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIO,
        .drvstr = MXC_GPIO_DRVSTR_0,
...
const mxc_gpio_cfg_t bsp_pins_adc_ch1_data_spi_active_cfg = {
        .port = MXC_GPIO3,
        .mask = (MXC_GPIO_PIN_2 | MXC_GPIO_PIN_3),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIO,
        .drvstr = MXC_GPIO_DRVSTR_0,
...
const mxc_gpio_cfg_t bsp_pins_gps_en_out_cfg = {
    .port = MXC_GPIO1,
...
const mxc_gpio_cfg_t bsp_pins_gps_pps_in_cfg = {
    .port = MXC_GPIO1,
...
const mxc_gpio_cfg_t bsp_pins_gps_uart_active_cfg = {
        .port = MXC_GPIO2,
        .mask = (MXC_GPIO_PIN_11 | MXC_GPIO_PIN_12),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIOH,
        .drvstr = MXC_GPIO_DRVSTR_0,
...
const mxc_gpio_cfg_t bsp_pins_rtc_coincell_adc_en_out_cfg = {
    .port = MXC_GPIO3,
    .mask = MXC_GPIO_PIN_9,
    .pad = MXC_GPIO_PAD_NONE,
    .func = MXC_GPIO_FUNC_OUT,
...
//AKA Audio power enable  //Originally using VDDIOH
...
/* UI Panel power button (commented out)
const mxc_gpio_cfg_t bsp_pins_ui_shutdown_in_cfg = {
    .port = MXC_GPIO0,
...
const mxc_gpio_cfg_t bsp_pins_console_uart_active_cfg = {
        .port = MXC_GPIO2,
        .mask = (MXC_GPIO_PIN_14 | MXC_GPIO_PIN_16),
        .pad = MXC_GPIO_PAD_NONE,
        .func = MXC_GPIO_FUNC_ALT1,
        .vssel = MXC_GPIO_VSSEL_VDDIO,
        .drvstr = MXC_GPIO_DRVSTR_0,
