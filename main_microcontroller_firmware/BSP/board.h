...
/**
 * @brief `bsp_delay_ms(ms)` delays the execution of the program for the given number of milliseconds.
 *
 * @param ms the number of milliseconds to delay.
 *
 * @post the program is delayed in blocking fashion for the given number of milliseconds.
 */
