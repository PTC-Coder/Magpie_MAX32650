...
int bsp_ble_uart_init()
{
    ...
    return MXC_UART_Init(bsp_uart_ble_uart_handle, BSP_BLE_UART_BAUD);
}
...
int bsp_console_uart_init()
{
    ...
    return MXC_UART_Init(bsp_uart_console_uart_handle, BSP_CONSOLE_UART_BAUD);
}
...
int bsp_gnss_uart_init()
{
    ...
    return MXC_UART_Init(bsp_uart_gps_uart_handle, BSP_GNSS_UART_BAUD);
}
