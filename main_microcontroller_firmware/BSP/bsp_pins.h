...
// NOR Flash reads and writes to the SPI flash memory
extern const mxc_gpio_cfg_t bsp_pins_nor_active_cfg;
extern const mxc_gpio_cfg_t bsp_pins_nor_high_z_cfg;
