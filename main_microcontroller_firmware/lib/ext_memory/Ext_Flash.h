...
#define EXT_FLASH_NAME "MX25L5124tGZ2I-08G"

#define EXT_FLASH_READ_DUMMY \
    8 /**< Dummy byte sent on a standard read command per the MX25L datasheet.         */
#define EXT_FLASH_DREAD_DUMMY \
    8 /**< Dummy data sent on a fast-read (Dual) read command per the MX25L datasheet. */
#define EXT_FLASH_QREAD_DUMMY \
    8 /**< Dummy data sent on a fast-read (Quad) read command per the MX25L datasheet. */

#define EXT_FLASH_EXP_ID 0xc2201a
