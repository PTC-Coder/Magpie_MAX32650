...
int sd_card_bank_ctl_read_and_cache_detect_pins()
{
    ...
    // Debug: print raw and processed detect values
    printf("[DEBUG] SD detect: raw=0x%02X, shifted=0x%02X, active_slot=%d\n", 
           read_byte, detect_pins_bitfield, (int)active_card_slot);
