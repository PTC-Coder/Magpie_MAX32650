 ...
 *
 * @pre the I2C bus on the 1.8V domain is configured as an I2C master.
 *
...
int tps22994_configure_ch0_and_ch1_for_i2c_control()
{
    ...
    mxc_i2c_req_t req = {
        .i2c = bsp_i2c_1v8_i2c_handle,  // TPS22994 is on 1.8V I2C bus per schematic
    ...
    if (result != E_NO_ERROR) {
        printf("[DEBUG] TPS22994 I2C error: %d (addr=0x%02X)\n", result, TPS22994_7_BIT_I2C_ADDRESS);
    }
    return result;
}
